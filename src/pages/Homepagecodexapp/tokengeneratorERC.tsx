...
import CardtokenERC from "./cardtokenERC";
const TokengeneratorICP: React.FC = () => {
          ...
          <div className="absolute md:h-[2285px] h-[2308px] inset-[0] justify-center m-auto pb-[23px] w-full">
            ...
            <div className="absolute flex flex-col gap-8 justify-center max-w-[660px] px-4 py-20 right-[6%] top-[7%] w-full">
              <div className="flex flex-col gap-8 items-center justify-start">
                ...
                >   <img                           className="h-[90px]"
                src="images/meta.png" alt="META Logo" />
                  Token Generator
                </Text>
                <Text
                ...
                >
                  Create and select our no-code token utility to effortlessly generate your utility token without the need for coding.
                </Text>
...
export default TokengeneratorICP;
